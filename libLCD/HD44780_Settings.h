...
//LCD pins			PORT, PIN
#define LCD_D4		D, 7 // Arduino 1
#define LCD_D5		D, 6 // Arduino 2
#define LCD_D6		D, 5 // Arduino 3
#define LCD_D7		D, 4 // Arduino 4
#define LCD_RS		B, 4 // Arduino 7
#define LCD_RW		B, 2 // Arduino 8
#define LCD_EN		B, 3 // Arduino 9
//----------------------------------------------//
#endif
